...
Realmente la practica es muy simple, estamos conectando una resistencia a un pin del arduino y a esta misma resitencia le conectamos un led a un pata y la otra a tierra, en el programa le decomis que ese pin sera de salida y que este mandara voltaje o estara encendiso cada 1sg y despues se apagara cada 1sg y estas instrucciones las tenemos en un bucle que lo que hace es repetir dichas instrucciones ideterminadas veces.

4. Inserte aquí las imágenes que considere como evidencias para demostrar el resultado obtenido.
<p align="center">
    <img alt="SalidaDigital" src="../img/c3-1evidencia.png" width=600 height=400>
</p>

:triangular_flag_on_post: [Ir a repositorio](https://github.com/seashelltec/SistemasProgramables/blob/master/blog/C3.1_SeashellMarquez_Masapan.md)

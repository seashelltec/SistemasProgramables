...
+ Calcular la corriente eléctrica total y el voltaje en cada resistencia 
    ...
    RT= 80ohms+ 120ohms+ 12ohms= 212ohms

    IT= 60volts/212ohms = 0.282A

    V1 = 80ohms * 0.282A =22.56volts

    V2=120ohms * 0.282A =33.84volts

    V3=12ohms * 0.282A = 3.384volts


![Cuestionario_Parte1](../img/C1.x_CalculoCircuito-3.png)

:triangular_flag_on_post: [Ir a repositorio]([/docs/D0.1_FundamentosElectronicaBasica.md](https://github.com/seashelltec/SistemasProgramables/blob/master/blog/C1.2_MarquezMillanSeashellVanessa_Masapan.md))
___
...
:house: [Ir a readme]([/docs/D0.1_FundamentosElectronicaBasica.md](https://github.com/seashelltec/SistemasProgramables))
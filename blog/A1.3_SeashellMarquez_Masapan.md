...
3. Una vez que conoce el tema a desarrollar, investigue y redacte dentro de este documento los puntos siguiente:
   ...
   - **Desarrollo**
    ...
    :books: [Ir a la presentación](https://github.com/seashelltec/SistemasProgramables/blob/master/Doc/A1.3_Tipos_Sensores_Comerciales.pdf)

    :movie_camera: [Video usando el sensor en un proyecto que mide las RPM](https://www.youtube.com/watch?v=J9Wx1d9Zx_E)
    - **Bibliográfia**
  
    :books: [Naylamp Mechatronics. (s. f.). Sensor Encoder Infrarrojo FC-03. Naylamp Mechatronics - Perú. Recuperado 6 de octubre de 2020](https://naylampmechatronics.com/robotica-movil/240-encoder-infrarrojo.html)

    :books: [Robot, A. (2016, 9 julio). Encoder y Arduino. Tutorial sobre el módulo sensor de velocidad IR con el comparador LM393 (Encoder FC-03). Blog sobre robótica personal](http://androminarobot.blogspot.com/2016/07/en-este-tutorial-mostramos-como-usar-el.html)

    :books: [Circuit Magic. (2016, 7 marzo). DIY RPM Tachometer with Arduino | RPM Counter | [Vídeo]. YouTube.](https://www.youtube.com/watch?reload=9&v=J9Wx1d9Zx_E)
...
4. Inserte imágenes de **evidencias** tales como son reuniones  de los integrantes del equipo realizadas para el desarrollo de la actividad
    ...
    <p align="center"> 
        <img alt="Evidencia 3" src="img/../../img/ref1.png"
    </p>

    <p align="center"> 
        <img alt="Evidencia 3" src="img/../../img/ref2.png"
    </p>
___
